use super::{
    ...
    LocalFunctionTokens, Token, TypedIdentifier, TypeFunctionTokens, TypeFunctionStatement,
};
...
impl FunctionBuilder {
    ...
    pub(crate) fn into_type_function_statement(
        ...
        let mut statement =
            TypeFunctionStatement::new(name, self.block, self.parameters, self.is_variadic, export_token.is_some());
        ...
        if let (
            ...
            statement.set_tokens(TypeFunctionTokens {
                r#type,
                function_body: FunctionBodyTokens {
                    function,
                    opening_parenthese,
